    ...
    final testCases = [
      {
        ...
        'expectedTitle': 'Founder Dashboard',
      },
      {
        'email': 'businessadmin@pharmacy.com',
        'password': '123456',
        'expectedTitle': 'Business Admin Dashboard',
      },
      {
        'email': 'manager@pharmacy.com',
        'password': '123456',
        'expectedTitle': 'Branch Manager Dashboard',
      },
      {
        'email': 'staff@pharmacy.com',
        'password': '123456',
        'expectedTitle': 'Staff Dashboard',
      },
      {
        'email': 'inventory@pharmacy.com',
        'password': '123456',
        'expectedTitle': 'Inventory Dashboard',
      },
    ];
    ...
    test('Login for all 5 roles', () async {
      for (final testCase in testCases) {
        ...
        try {
          ...
          print(
            'Email field not found, maybe stuck on a dashboard. Attempting to logout...',
          );
          try {
        ...
        try {
          ...
          print(
            'Logout button not found, restarting app state might be needed',
          );
        }
      }
