...
import 'package:pharmacy_chains_management_fe/features/inventory/boundary/issue_stock_screen.dart';
...
void main() {
  ...
  testWidgets('Issue Stock screen renders outbound form and pick list correctly', (tester) async {
    ...
    expect(find.text('Outbound Picking & Branch Dispatch (Quản Lý Xuất Kho & Cung Ứng)'), findsOneWidget);
    expect(find.text('Panadol Extra 500mg (Paracetamol & Caffeine)'), findsWidgets);
    expect(find.text('🚚 Niêm Phong Kiện Hàng & Xuất Kho Cung Ứng (Dispatch)'), findsOneWidget);
  });
}
