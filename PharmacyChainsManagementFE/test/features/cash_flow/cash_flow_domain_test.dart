...
void main() {
  group('💸 Cash Flow Unit Test - Domain Entities', () {
    test(
      'CashFlowDailyDataEntity so sánh Equatable chính xác theo ngày và dòng tiền',
      () {
    ...
    test(
      'CashFlowStatisticsEntity quản lý tổng dòng tiền thu chi ròng chính xác',
      () {
        final date = DateTime(2026, 7, 18);
        final daily = [
          CashFlowDailyDataEntity(
            date: date,
            inflow: 10000000.0,
            outflow: 4000000.0,
          ),
        ...
        expect(
          stats.netCashFlow,
          equals(stats.totalInflow - stats.totalOutflow),
        );
