...
class PrescriptionListItemDto extends Equatable {
  ...
  factory PrescriptionListItemDto.fromJson(Map<String, dynamic> json) =>
...
class PrescriptionLineDto extends Equatable {
  ...
  factory PrescriptionLineDto.fromJson(Map<String, dynamic> json) =>
      PrescriptionLineDto(
        prescriptionDetailId: json['prescriptionDetailId'] as String,
  ...
  factory PrescriptionDto.fromJson(Map<String, dynamic> json) =>
      PrescriptionDto(
        ...
        items: ((json['items'] as List?) ?? [])
            .map(
              (item) =>
                  PrescriptionLineDto.fromJson(item as Map<String, dynamic>),
            )
            .toList(),
      );
  @override
