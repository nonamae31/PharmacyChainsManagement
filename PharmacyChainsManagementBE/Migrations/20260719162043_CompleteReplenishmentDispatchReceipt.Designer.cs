...
namespace PharmacyChainsManagementBE.Migrations
{
    ...
    [Migration("20260719162043_CompleteReplenishmentDispatchReceipt")]
    partial class CompleteReplenishmentDispatchReceipt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.DamageReport", b =>
                {
                    b.Property<Guid>("DamageReportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("damage_report_id");
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.InventoryAdjustment", b =>
                {
                    ...
                    b.Property<Guid?>("StocktakeDetailId")
                        .HasColumnType("uuid")
                        .HasColumnName("stocktake_detail_id");
                    ...
                    b.ToTable("INVENTORY_ADJUSTMENT");
                });

            modelBuilder.Entity("PharmacyChainsManagementBE.Models.InventoryReceipt", b =>
                {
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.InventoryReceiptDetail", b =>
                {
                    ...
                    b.ToTable("INVENTORY_RECEIPT_DETAIL");
                });
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StaffAttendance", b =>
                {
                    ...
                    b.HasIndex(new[] { "BranchId", "AttendanceDate" }, "IX_STAFF_ATTENDANCE_BranchDate");

                    b.HasIndex(new[] { "StaffId", "AttendanceDate" }, "UQ_STAFF_ATTENDANCE_StaffDate")
                        .IsUnique();

                    b.ToTable("STAFF_ATTENDANCE");
                });

            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StaffPayRate", b =>
                {
                    b.Property<Guid>("PayRateId")
                        .HasColumnType("uuid")
                        .HasColumnName("pay_rate_id");
                    ...
                    b.HasIndex(new[] { "BranchId", "StaffId" }, "UQ_STAFF_PAY_RATE_BranchStaff")
                        .IsUnique();

                    b.ToTable("STAFF_PAY_RATE");
                });

            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StaffPayroll", b =>
                {
                    ...
                    b.HasIndex(new[] { "BranchId", "StaffId", "PeriodStart", "PeriodEnd" }, "UQ_STAFF_PAYROLL_BranchStaffPeriod")
                        .IsUnique();

                    b.ToTable("STAFF_PAYROLL");
                });
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StaffWeeklySchedule", b =>
                {
                    ...
                    b.HasIndex(new[] { "BranchId", "StaffId" }, "UQ_STAFF_WEEKLY_SCHEDULE_BranchStaff")
                        .IsUnique();

                    b.ToTable("STAFF_WEEKLY_SCHEDULE");
                });

            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StockIssue", b =>
                {
                    ...
                    b.ToTable("STOCK_ISSUE");
                });

            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StockIssueDetail", b =>
                {
                    ...
                    b.ToTable("STOCK_ISSUE_DETAIL");
                });

            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StockReplenishmentRequest", b =>
                {
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StockReplenishmentRequestDetail", b =>
                {
                    ...
                    b.HasIndex("RequestId", "MedicineId")
                        .IsUnique();

                    b.ToTable("STOCK_REPLENISHMENT_REQUEST_DETAIL");
                });
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.Stocktake", b =>
                {
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StocktakeDetail", b =>
                {
                    b.Property<Guid>("StocktakeDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.InventoryAdjustment", b =>
                {
                    b.HasOne("PharmacyChainsManagementBE.Models.Inventory", "Inventory")
                        .WithMany("InventoryAdjustments")
                        .HasForeignKey("InventoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PharmacyChainsManagementBE.Models.StocktakeDetail", "StocktakeDetail")
                        .WithMany("InventoryAdjustments")
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.InventoryReceipt", b =>
                {
                    b.HasOne("PharmacyChainsManagementBE.Models.PurchaseOrder", "PurchaseOrder")
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.InventoryReceiptDetail", b =>
                {
                    ...
                    b.HasOne("PharmacyChainsManagementBE.Models.InventoryReceipt", "Receipt")
                        .WithMany("InventoryReceiptDetails")
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StockIssueDetail", b =>
                {
                    b.HasOne("PharmacyChainsManagementBE.Models.MedicineBatch", "Batch")
                        .WithMany("StockIssueDetails")
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PharmacyChainsManagementBE.Models.StockIssue", "Issue")
                        .WithMany("StockIssueDetails")
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StockReplenishmentRequest", b =>
                {
                    ...
                    b.HasOne("PharmacyChainsManagementBE.Models.User", "ProcessedByNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StockReplenishmentRequestDetail", b =>
                {
                    ...
                    b.HasOne("PharmacyChainsManagementBE.Models.StockReplenishmentRequest", "Request")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.StocktakeDetail", b =>
                {
                    ...
                    b.HasOne("PharmacyChainsManagementBE.Models.Stocktake", "Stocktake")
                        .WithMany("StocktakeDetails")
            ...
            modelBuilder.Entity("PharmacyChainsManagementBE.Models.Medicine", b =>
                {
                    ...
                    b.Navigation("StockIssueDetails");
