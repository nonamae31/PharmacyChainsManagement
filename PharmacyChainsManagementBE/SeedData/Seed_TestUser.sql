...
VALUES
    ...
    ('44444444-4444-4444-4444-444444444444', 4, 'Inventory Manager', 'inventory@pharmacy.com', '$2a$11$IYQJvf0r3oqJXCtfmuNC.ut.sFypUr1LtCajqdfXki2WAbbAu3p4a', 'ACTIVE', NOW(), NOW())
